...
## 2. A szoftverfejlesztés életciklusa
...
## 3. Agilis fejlesztési módszertanok
...
#### 3.3.6. Feature implementáció állapotai
...
#### 3.3.7. Feature előkészítés állapotai
...
#### 3.3.13. Definition of Ready (DoR)
...
## 4. Feature Fejlesztési Életciklus
...
### 4.3. Implementáció előkészítése
...
## 6. A szoftverarchitektúra alapjai
...
### 6.2. Adattranszfer Objektumok (DTOs)
...
### 6.3. Függőséginjektálás (Dependency Injection - DI)
...
### 7.3. Build, Test, Deploy Pipeline
...
### 8.3. Feature Branch Életciklusa
...
## 9. Tesztelés a szoftverfejlesztésben
...
## 10. Fejlesztési gyakorlatok és minőségbiztosítás
...
##### 12.3.6.2. OpenSearch kulcsfogalmai
...
## 13. Technikai adósság és refaktorálás
